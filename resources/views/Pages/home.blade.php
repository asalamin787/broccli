                    ...
                    <div class="row">
                        <div class="col-lg-12 align-self-center">
                            <div class="slide-item-info">
                                <div class="slide-item-info-inner ltn__slide-animation">
                                    ...
                                    <h6 class="slide-sub-title animated"><img
                                            src="{{ asset('assets/img/icons/icon-img/1.png') }}" alt="#">
                                        100%
                                        genuine Products</h6>
                            ...
                            <div class="slide-item-img">
                                <img src="{{ asset('assets/img/slider/23.png') }}" alt="#">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="ltn__banner-item">
                <div class="ltn__banner-img">
                    <a href="shop.html"><img src="{{asset('assets/img/banner/1.jpg')}}" alt="Banner Image"></a>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6">
            <div class="ltn__banner-item">
                <div class="ltn__banner-img">
                    <a href="shop.html"><img src="{{asset('assets/img/banner/2.jpg')}}" alt="Banner Image"></a>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6">
...
<div class="container">
    <div class="row ltn__custom-gutter--- justify-content-center">
        <div class="col-lg-6 col-md-6">
            <div class="ltn__banner-item">
                <div class="ltn__banner-img">
                    <a href="shop.html"><img src="{{asset('assets/img/banner/13.png')}}" alt="Banner Image"></a>
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-6">
            <div class="row">
                <div class="col-lg-12">
                    <div class="ltn__banner-item">
                        <div class="ltn__banner-img">
                            <a href="shop.html"><img src="{{asset('assets/img/banner/14.png')}}" alt="Banner Image"></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="ltn__banner-item">
                        <div class="ltn__banner-img">
                            <a href="shop.html"><img src="{{asset('assets/img/banner/15.png')}}" alt="Banner Image"></a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row ltn__tab-product-slider-one-active slick-arrow-1">
                                ...
                                <div class="col-lg-12">
                                    <div class="ltn__product-item ltn__product-item-3 text-center">
                                        <div class="product-img">
                                            <a href="product-details.html"><img
                                                    src="{{ asset('assets/img/product/11.png') }}"
                                                    alt="#"></a>
                                    ...
                                    <div class="ltn__product-item ltn__product-item-3 text-center">
                                        <div class="product-img">
                                            <a href="product-details.html"><img
                                                    src="{{ asset('assets/img/product/7.png') }}"
                                                    alt="#"></a>
                                            <div class="product-badge">
                                                <ul>
                                ...
                                <div class="col-lg-12">
                                    <div class="ltn__product-item ltn__product-item-3 text-center">
                                        <div class="product-img">
                                            <a href="product-details.html"><img
                                                    src="{{ asset('assets/img/product/12.png') }}"
                                                    alt="#"></a>
                                            <div class="product-badge">
                                                <ul>
                                                    <li class="sale-badge">-19%</li>
                                    ...
                                    <div class="ltn__product-item ltn__product-item-3 text-center">
                                        <div class="product-img">
                                            <a href="product-details.html"><img
                                                    src="{{ asset('assets/img/product/8.png') }}"
                                                    alt="#"></a>
                                            <div class="product-badge">
                                                <ul>
                                                    <li class="sale-badge">New</li>
                                ...
                                <div class="col-lg-12">
                                    <div class="ltn__product-item ltn__product-item-3 text-center">
                                        <div class="product-img">
                                            <a href="product-details.html"><img
                                                    src="{{ asset('assets/img/product/13.png') }}"
                                                    alt="#"></a>
                                            <div class="product-badge">
                                                <ul>
                                                    <li class="sale-badge">New</li>
                                    ...
                                    <div class="ltn__product-item ltn__product-item-3 text-center">
                                        <div class="product-img">
                                            <a href="product-details.html"><img
                                                    src="{{ asset('assets/img/product/9.png') }}"
                                                    alt="#"></a>
                                            <div class="product-badge">
                                                <ul>
                                                    <li class="sale-badge">-19%</li>
                                ...
                                <div class="col-lg-12">
                                    <div class="ltn__product-item ltn__product-item-3 text-center">
                                        <div class="product-img">
                                            <a href="product-details.html"><img
                                                    src="{{ asset('assets/img/product/14.png') }}"
                                                    alt="#"></a>
                                            <div class="product-badge">
                                                <ul>
                                                    <li class="sale-badge">New</li>
                                    ...
                                    <div class="ltn__product-item ltn__product-item-3 text-center">
                                        <div class="product-img">
                                            <a href="product-details.html"><img
                                                    src="{{ asset('assets/img/product/10.png') }}"
                                                    alt="#"></a>
                                            <div class="product-badge">
                                                <ul>
                                                    <li class="sale-badge">New</li>
                                ...
                                <div class="col-lg-12">
                                    <div class="ltn__product-item ltn__product-item-3 text-center">
                                        <div class="product-img">
                                            <a href="product-details.html"><img
                                                    src="{{ asset('assets/img/product/15.png') }}"
                                                    alt="#"></a>
                                            <div class="product-badge">
                                                <ul>
                                                    <li class="sale-badge">New</li>
                                    ...
                                    <div class="ltn__product-item ltn__product-item-3 text-center">
                                        <div class="product-img">
                                            <a href="product-details.html"><img
                                                    src="{{ asset('assets/img/product/6.png') }}"
                                                    alt="#"></a>
                                            <div class="product-badge">
                                                <ul>
                                                    <li class="sale-badge">-19%</li>
...
<div class="ltn__call-to-action-area ltn__call-to-action-4 section-bg-1 pt-110 pb-120">
    <div class="container">
        <div class="row">
            <div class="col-lg-5">
                <img src="{{ asset('assets/img/banner/11.png') }}" alt="#">
            </div>
            <div class="col-lg-7">
        ...
        <div class="row ltn__tab-product-slider-one-active--- slick-arrow-1">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                <div class="ltn__product-item ltn__product-item-3 text-left">
                    <div class="product-img">
                        <a href="product-details.html"><img src="{{ asset('assets/img/product/1.png') }}"
                                alt="#"></a>
                        <div class="product-badge">
                            <ul>
                                <li class="sale-badge">New</li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                <div class="ltn__product-item ltn__product-item-3 text-left">
                    <div class="product-img">
                        <a href="product-details.html"><img src="{{ asset('assets/img/product/2.png') }}"
                                alt="#"></a>
                        <div class="product-hover-action">
                            <ul>
                                <li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                <div class="ltn__product-item ltn__product-item-3 text-center">
                    <div class="product-img">
                        <a href="product-details.html"><img src="{{ asset('assets/img/product/3.png') }}"
                                alt="#"></a>
                        <div class="product-badge">
                            <ul>
                                <li class="sale-badge">New</li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                <div class="ltn__product-item ltn__product-item-3 text-center">
                    <div class="product-img">
                        <a href="product-details.html"><img src="{{ asset('assets/img/product/4.png') }}"
                                alt="#"></a>
                        <div class="product-badge">
                            <ul>
                                <li class="sale-badge">New</li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                <div class="ltn__product-item ltn__product-item-3 text-center">
                    <div class="product-img">
                        <a href="product-details.html"><img src="{{ asset('assets/img/product/5.png') }}"
                                alt="#"></a>
                        <div class="product-badge">
                            <ul>
                                <li class="sale-badge">New</li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                <div class="ltn__product-item ltn__product-item-3 text-center">
                    <div class="product-img">
                        <a href="product-details.html"><img src="{{ asset('assets/img/product/6.png') }}"
                                alt="#"></a>
                        <div class="product-badge">
                            <ul>
                                <li class="sale-badge">New</li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                <div class="ltn__product-item ltn__product-item-3 text-center">
                    <div class="product-img">
                        <a href="product-details.html"><img src="{{ asset('assets/img/product/7.png') }}"
                                alt="#"></a>
                        <div class="product-badge">
                            <ul>
                                <li class="sale-badge">New</li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                <div class="ltn__product-item ltn__product-item-3 text-center">
                    <div class="product-img">
                        <a href="product-details.html"><img src="{{ asset('assets/img/product/8.png') }}"
                                alt="#"></a>
                        <div class="product-badge">
                            <ul>
                                <li class="sale-badge">New</li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ltn__video-bg-img ltn__video-popup-height-600 bg-overlay-black-10-- bg-image"
                    data-bg="{{ asset('assets/img/bg/15.jpg') }}">
                    <a class="ltn__video-icon-2 ltn__video-icon-2-border"
                        href="https://www.youtube.com/embed/ATI7vfCgwXE?autoplay=1&amp;showinfo=0"
                        data-rel="lightcase:myCollection">
                        <i class="fa fa-play"></i>
    ...
    <div class="container-fluid">
        ...
        <div class="row ltn__testimonial-slider-3-active slick-arrow-1 slick-arrow-1-inner">
            <div class="col-lg-12">
                <div class="ltn__testimonial-item ltn__testimonial-item-4">
                    <div class="ltn__testimoni-img">
                        <img src="{{ asset('assets/img/testimonial/6.jpg') }}" alt="#">
                    </div>
            ...
            <div class="col-lg-12">
                <div class="ltn__testimonial-item ltn__testimonial-item-4">
                    <div class="ltn__testimoni-img">
                        <img src="{{ asset('assets/img/testimonial/7.jpg') }}" alt="#">
                    </div>
                    <div class="ltn__testimoni-info">
                        <p>Lorem ipsum dolor sit amet, consectetur adipi sicing elit, sed do eiusmod tempor
                            incididunt ut labore et dolore magna aliqua. </p>
    ...
    <div class="container">
        ...
        <div class="row  ltn__blog-slider-one-active slick-arrow-1 ltn__blog-item-3-normal">
            ...
            <div class="col-lg-12">
                <div class="ltn__blog-item ltn__blog-item-3">
                    <div class="ltn__blog-img">
                        <a href="blog-details.html"><img src="{{ asset('assets/img/blog/5.jpg') }}"
                                alt="#"></a>
                    </div>
                    <div class="ltn__blog-brief">
                        <div class="ltn__blog-meta">
