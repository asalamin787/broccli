<x-dashboard.admin>
    @push('css')
    <link href="{{asset('assets/vendor_dashboard/libs/select2/css/select2.min.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('assets/vendor_dashboard/libs/dropzone/dropzone.css')}}" rel="stylesheet" type="text/css" />
    @endpush
    <div class="row">
        <div class="col-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="productdesc" rows="5" placeholder="Product Description" style="height: 129px;"></textarea>
                                </div>
    ...
    @push('js')
        {{-- <script src="{{asset('assets/vendor_dashboard/js/plugin.js')}}"></script> --}}
        <script src="{{asset('assets/vendor_dashboard/libs/select2/js/select2.min.js')}}"></script>
        <script src="{{asset('assets/vendor_dashboard/libs/dropzone/dropzone-min.js')}}"></script>>
        <script src="{{asset('assets/vendor_dashboard/js/pages/ecommerce-select2.init.js')}}"></script>
    @endpush
</x-dashboard.admin>