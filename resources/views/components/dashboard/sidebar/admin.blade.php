<x-dashboard.sidebar.main>
    ...
    <x-dashboard.sidebar.nav.list label="Products" icon="bx-user">
        <x-dashboard.sidebar.nav.item label="Products" icon="bx-list-plus" :href="url('/')" />
        <x-dashboard.sidebar.nav.item label="Category" icon="bx-list-plus" :href="url('/')" />
    </x-dashboard.sidebar.nav.list>
