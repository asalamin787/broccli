                    ...
                    <div class="row">
                                        ...
                                        <ul>
                                            ...
                                            <li class="menu-icon"><a href="#">Shop</a>
                                                <ul>
                                                    ...
                                                    <li><a href="product-details-no-sidebar.html">Shop details no
                                                            sidebar </a></li>
                        ...
                        <div class="ltn__header-options ltn__header-options-2">
                            ...
                            <div class="mini-cart-icon">
                                <a href="#" class="ltn__utilize-toggle d-flex"
                    ...
                    <ul>
                        <li><a href="{{ route('home') }}">Home</a>
                            {{-- <ul class="sub-menu">
                                ...
                                <li><a href="index-5.html">Home Pages 05 <span
                                            class="menu-item-badge">video</span></a></li>
